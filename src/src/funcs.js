...
function hsLayoutFunc(obj={},e) {
  let {oneTimesWidth,oneTimesHeight,el,cssVar,setWrapAttr,adaptEvent,adaptedCallback}=obj;
...
function directiveBindfunction (el, binding) {
  let { cssVar,width,height,times,triggerTime,AdaptEventName,setWrapAttr} = binding.attrs;
